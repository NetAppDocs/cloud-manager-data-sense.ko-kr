...
Azure NetApp Files 볼륨을 스캔하기 전에 https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["구성을 검색하려면 Cloud Manager를 설정해야 합니다"^].
...
https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["Cloud Manager에서 Azure NetApp Files 시스템을 검색하는 방법을 알아보십시오"^].
